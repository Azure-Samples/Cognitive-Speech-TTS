...
typedef void(*ON_HTTP_REPLY_RECV_CALLBACK)(HTTP_CLIENT_HANDLE handle, void* callback_ctx, const unsigned char* content, size_t contentLen, unsigned int statusCode,
    HTTP_HEADERS_HANDLE responseHeadersHandle);
typedef void(*ON_HTTP_CHUNK_REPLY_CALLBACK)(HTTP_CLIENT_HANDLE handle, void* callback_ctx, const unsigned char* content, size_t contentLen, unsigned int statusCode,
    HTTP_HEADERS_HANDLE responseHeadersHandle, bool replyComplete);

MOCKABLE_FUNCTION(, HTTP_CLIENT_HANDLE, http_client_create, XIO_HANDLE, xioHandle, ON_HTTP_CONNECTED_CALLBACK, onConnected, ON_HTTP_REPLY_RECV_CALLBACK, on_http_reply_recv, ON_HTTP_ERROR_CALLBACK, on_http_error, ON_HTTP_CHUNK_REPLY_CALLBACK, on_chunk_reply, void*, callback_ctx);
...
MOCKABLE_FUNCTION(, HTTP_CLIENT_RESULT, http_client_send_chunk_request, HTTP_CLIENT_HANDLE, handle, const unsigned char*, content, size_t, chunkSize);
...
MOCKABLE_FUNCTION(, HTTP_CLIENT_RESULT, http_client_set_trace, HTTP_CLIENT_HANDLE, handle, bool, traceOn);
MOCKABLE_FUNCTION(, HTTP_CLIENT_RESULT, http_client_set_proxy_auth, HTTP_CLIENT_HANDLE, handle, const char*, username, const char*, password);
