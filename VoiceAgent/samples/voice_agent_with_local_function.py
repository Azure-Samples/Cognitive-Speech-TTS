...
spoken result. The conversation JSON and audio files are saved, and the agent
remains available after the sample exits.
"""
        ...
        try:
            async for event in connection:
                ...
                if event_type == "input_audio_buffer.speech_started":
                    ...
                    # Native functions are client-executed, so the client asks
                    # the model to continue after returning the output.
