...
The sample creates or reuses a knowledge-grounded agent and opens a Voice Agent
session, prints user/agent transcripts, plays response audio, and captures the
persisted conversation id. Use the separate artifact downloader for JSON and
audio. The agent remains available after the sample exits. Use a headset to
reduce echo.
"""
