...
// The create body: POST /agents { name, description, definition } (matches common.create_agent).
...
export function buildHostedAgentVoiceBody({
  ...
  const definition = {
    ...
    audio: {
      ...
      output: {
        format: { type: "audio/pcm", rate: 24000 },
        voice: { type: "azure-standard", name: outputVoiceName },
      },
    },
    output_modalities: ["audio"],
  };
