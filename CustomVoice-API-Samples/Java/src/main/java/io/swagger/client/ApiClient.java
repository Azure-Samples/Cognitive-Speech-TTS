...
public class ApiClient {
    ...
    public ApiClient(String basePath) {
        ...
        authentications.put("subscription_key", new ApiKeyAuth("header", "Ocp-Apim-Subscription-Key"));
    ...
    public Response NewExecute(Call call, Type returnType) throws ApiException {
        try {
            Response response = call.execute();
            return response;
            //T data = handleResponse(response, returnType);
